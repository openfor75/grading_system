...
def get_drive_service():
    ...
    try:
        ...
        st.error(f"❌ Google Drive 連線失敗: {e}")
        return None
...
# --- 模式2: 衛生股長 (整合申訴功能) ---
    ...
    if not df.empty:
        ...
        st.session_state.cls_selected = cls
